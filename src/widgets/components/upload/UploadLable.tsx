    ...
    return (
        <div>
            ...
            <div className="text-sm text-indigo-700/80 space-y-1">
                ...
                <p>Загрузите файл акта сверки в формате Excel. Система использует проверку: алгоритм сравнит дебет, кредит, номер документа и даты операций. При расхождениях покажем детальный отчёт.</p>
            </div>
            </div>
        </div>
    )
