          ...
          {!expanded && (
            <div className="text-sm text-slate-500">
              <div className="flex flex-wrap gap-4">
                <span>Акт 1: <span className="font-medium text-slate-800">{item.act1Value}</span></span>
                <span className="text-slate-400">→</span>
                <span>Акт 2: <span className="font-medium text-rose-600">{item.act2Value}</span></span>
              </div>
            </div>
          )}
        </div>
